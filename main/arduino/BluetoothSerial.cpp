...
static bool _spp_send_buffer() {
	if ((xEventGroupWaitBits(_spp_event_group, SPP_CONGESTED, pdFALSE, pdTRUE,
			portMAX_DELAY) & SPP_CONGESTED)) {
...
static void _spp_tx_task(void * arg) {
	...
	for (;;) {
		if (_spp_tx_queue
				&& xQueueReceive(_spp_tx_queue, &packet, portMAX_DELAY)
						== pdTRUE && packet) {
			if (packet->len <= (SPP_TX_MAX - _spp_tx_buffer_len)) {
				memcpy(_spp_tx_buffer + _spp_tx_buffer_len, packet->data,
						packet->len);
...
//			log_i(SPP_TAG, "authentication success: %s", param->auth_cmpl.device_name);
//			esp_log_buffer_hex(SPP_TAG, param->auth_cmpl.bda, ESP_BD_ADDR_LEN);
//		} else {
//			log_e(SPP_TAG, "authentication failed, status:%d", param->auth_cmpl.stat);
//		}
//		break;
//	}
//	case ESP_BT_GAP_PIN_REQ_EVT: {
//		log_i(SPP_TAG, "ESP_BT_GAP_PIN_REQ_EVT min_16_digit:%d", param->pin_req.min_16_digit);
//		if (param->pin_req.min_16_digit) {
//			log_i(SPP_TAG, "Input pin code: 0000 0000 0000 0000");
//			esp_bt_pin_code_t pin_code = { 0 };
//			esp_bt_gap_pin_reply(param->pin_req.bda, true, 16, pin_code);
//		} else {
//			log_i(SPP_TAG, "Input pin code: 1234");
...
//    	log_i(SPP_TAG, "ESP_BT_GAP_CFM_REQ_EVT Please compare the numeric value: %d", param->cfm_req.num_val);
//        esp_bt_gap_ssp_confirm_reply(param->cfm_req.bda, true);
//        break;
//    case ESP_BT_GAP_KEY_NOTIF_EVT:
//    	log_i(SPP_TAG, "ESP_BT_GAP_KEY_NOTIF_EVT passkey:%d", param->key_notif.passkey);
//        break;
//    case ESP_BT_GAP_KEY_REQ_EVT:
//    	log_i(SPP_TAG, "ESP_BT_GAP_KEY_REQ_EVT Please enter passkey!");
//        break;
//#endif
//
//	default: {
//		log_i(SPP_TAG, "event: %d", event);
//		break;
//	}
//	}
//	return;
...
//		log_e(SPP_TAG, "%s gap register failed: %s\n", __func__, esp_err_to_name(ret));
//		return false;
//	}
